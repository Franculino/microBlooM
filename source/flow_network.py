...
class FlowNetwork(object):
    ...
    def __init__(self, imp_readnetwork: readnetwork.ReadNetwork, imp_writenetwork: writenetwork.WriteNetwork,
        ...
        # Totuous network attributes
        self.diameters_points = None
        self.inner_edges_lengths = None
        self.tortuous_points = None
