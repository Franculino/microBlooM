...
PARAMETERS = MappingProxyType(
    {
        ...
        "pkl_path_igraph": "C:/Users/manuf/Documents/2º DELFT/Intership/microBlooM/testcases/MVN1_corrected_SI.pkl",
...
if rank == 0:
    ...
    start_velocity = time.process_time()
    velocity_x, velocity_y, velocity_z = particle_tracker.compute_velocity_components()
