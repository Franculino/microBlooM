...
PARAMETERS = MappingProxyType(
    {
        ...
        "mu_plasma": 0.0052,
        "boundary_hematocrit": 0.4,  # np.random.uniform(low=0.09, high=0.11, size=2000),  # np.full(2000, 0.1)
        # #: np.array([0.1] * 2000),  #
        "network_name": "MVN2_05_alpha_the_same",
        ...
        "write_path_igraph": "data/out/13_11/paraview/MVN2_05_alpha_the_same.vtp",
        # only required for "write_network_option" 2
        "save": True,
        "path_for_graph": "data/out/13_11/MVN2_05_alpha_the_same/plot",

        # Write option in case of print in output file (.txt)
        "path_output_file": "data/out/13_11/MVN2_05_alpha_the_same/log_file",
